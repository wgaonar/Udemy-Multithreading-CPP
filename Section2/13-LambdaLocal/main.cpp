...
int main()
{
  ...
  std::cout << "Calling add_two(3) gives: " << add_two(3) << std::endl;
  ...
  std::cout << "Calling add_z_plus_one(2) gives: " << add_z_plus_one(2) << std::endl;
  std::cout << "Calling add_z_plus_one(3) gives: " << add_z_plus_one(3) << std::endl;
