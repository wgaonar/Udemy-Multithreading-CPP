/*
  ...
  The philosophers are able to eat
  NO Deadlock
*/
#include<iostream>
#include<thread>
...
void dine(int n_philo)
{
  ...
  */
  ...
  print(n_philo, "\'s forks are ", l_fork, r_fork);
  print(n_philo, " is thinking...");

  std::this_thread::sleep_for(think_time);

  // Make an attempt to eat
  print(n_philo, " reaches for forks number ", l_fork, r_fork);
  ...
  print(n_philo, " puts down forks ", l_fork, r_fork);
  print(n_philo, " is thinking...");
